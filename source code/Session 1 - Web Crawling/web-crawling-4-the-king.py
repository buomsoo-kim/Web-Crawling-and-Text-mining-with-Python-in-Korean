#!usr/bin/env python
# File name....: web-crawling-4-the-king.py
...
# 영화 <더 킹> 리뷰 첫 번째 페이지에서 총 페이지 개수 계산하기
url = 'http://movie.daum.net/moviedb/grade?movieId=98333&type=netizen&page=1'
webpage = urlopen(url)
...
for n in range(page_no):
	# 불러오려는 url 입력하기
	url = 'http://movie.daum.net/moviedb/grade?movieId=98333&type=netizen&page={}'.format(n + 1)
...
# ///// END OF web-crawling-4-the-king ////////////////////////////////////////